...
/*********************************************************/
  ...
  document.querySelector("#session_entry").value=window.lightdm.default_session
	...
	window.authentication_complete = function() {
      ...
      setTimeout(() => {
        let session = window.lightdm.sessions.find(item => item.key==document.querySelector("#session_entry").value);
